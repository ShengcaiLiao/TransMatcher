function [num_matches, img] = draw_lines(images, height, width, prob_score, index_in_gal, index_i, index_j, layer, threshold)
  ...
  match_score = prob_score(index_i, index_j, layer, :, :);
  match_score = reshape(match_score, [hei, wid]);
  match_index = index_in_gal(index_i, index_j, layer, :, :);
